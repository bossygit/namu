...
public class SmsRequest {
    ...
    public static final String URL_POST = "https://nasande.cg/process";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(i == 1){
                                ...
                                Log.d(TAG,mess);
                                Toast.makeText(MainActivity.getAppContext(),"Taille "+ mess.length() +" Password " +pass +"identifiant "+identifiant , Toast.LENGTH_SHORT).show();
                                envoi_sms(mess);
                            }
